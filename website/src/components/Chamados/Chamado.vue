				...
				<div class="row form-group">
					<div class="col-9 row">
						<div class="form-group text-left row my-3">
							<label for="usuario" class="pt-2"> Título: </label>
						...
						<div class="form-group text-left row my-3">
							<label for="descrição" class="pt-2"> Descrição: </label>

							<textarea class="form-control" v-model="description" />
						</div>

						<div class="form-group text-left row my-3">
							<label for="descrição" class="pt-2"> Anexos: </label>
	...
	export default {
		...
		methods: {
			...
			handleSubmit() {
				...
				this.$http
					.post("http://localhost:8000/api/call/store", this.call)
					.then((response) => {
